...
const appRegistry = [
  {
    ...
    html: '/apps/Notes/index.html', // Changed from script to html
    defaultWidth: 600,
    defaultHeight: 450,
    minWidth: 500,
    minHeight: 400,
  },
  {
    ...
    html: '/apps/Calculator/index.html', // Changed from script to html
  ...
  },
  {
    ...
    html: '/apps/Calendar/index.html', // Changed from script to html
    defaultWidth: 380,
    defaultHeight: 350,
    minWidth: 300,
    minHeight: 300,
